...
<body>
    <div id="dashboardApp" class="showAside position_relative">
        ...
        <main class="main_content">
            <form action="{{ route('manager.product.store_add') }}"  enctype="multipart/form-data" method="POST">
                @csrf
                            ...
                            <div id="table_content">
                                ...
                                <div class="tab_content">
                                    <div class="tab_pane" id="tab_general">
                                        <div class="form_group status_wrap d_flex align_items_center flex-wrap">
                                            ...
                                            <div class="switch_status">
                                                <label for="status_value" class="status_toggle on">
                                                    <input type="checkbox"  {{ old('prod_is_status') == "on" ? "checked" :null }} name="prod_is_status" id="status_value" class="d_none">
                                        ...
                                        <div class="content_group">
                                            <div class="form_group d_flex align_items_center flex-wrap">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" value="{{ old('prod_name') }}" type="text" name="prod_name" id="prod_name" placeholder="Tên sản phẩm" autocomplete="off" spellcheck="false">
                                                </div>
                                            ...
                                            {{-- <div class="form_group d_flex align_items_center flex-wrap">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" value="{{ old('prod_meta_desc') }}" type="text" name="prod_meta_desc" id="prod_meta_desc" placeholder="Thẻ mô tả (Meta desc)" autocomplete="off" spellcheck="false">
                                                </div>
                                            ...
                                            <div class="form_group d_flex align_items_center flex-wrap">
                                                ...
                                                <div class="form_input">
                                                    <textarea class="form_control" name="prod_short_desc" id="prod_short_desc" autocomplete="off"  spellcheck="false" cols="30" rows="10">{{ old('prod_meta_desc') }}</textarea>
                                                </div>
                                                <div class=" form_label" style="margin: 10px 0 0 220px">
                                            ...
                                            <div class="form_group d_flex align_items_center flex-wrap">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" value="{{ old('prod_meta_title') }}" type="text" name="prod_meta_title" id="prod_meta_title" placeholder="Thẻ tiêu đề (Meta title)" autocomplete="off" spellcheck="false">
                                                </div>
                                            ...
                                            <div class="form_group d_flex align_items_center flex-wrap">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" value="{{ old('prod_meta_keywords') }}" type="text" name="prod_meta_keywords" id="prod_meta_keywords" placeholder="Thẻ mô tả (Meta desc)" autocomplete="off" spellcheck="false">
                                                </div>
                                            </div>
                                            <div class="form_group d_flex align_items_center flex-wrap">
                                                <label for="search_gg_info" class="form_label">Xem trước kết quả tìm kiếm</label>
                                                <div class="form_input">
                                                    <div class="google_title">{{ old('prod_meta_title') }}</div>
                                                    <div class="google_url">
                                                        <span class="default">Cellphones.com/</span>
                                                        <span class="url">{{ old('prod_meta_seourl') }}</span>
                                                    </div>
                                                    <div class="google_desc">{{ old('prod_meta_desc') }}</div>
                                                </div>
                                            </div>
                                            <div class="form_group seoUrl d_flex align_items_center flex-wrap">
                                                <label for="prod_meta_seourl" class="form_label"><strong style="color: #f00;">*</strong> Đường dẫn SEO</label>
                                                <div class="form_input">
                                                    <input class="form_control" type="text" id="prod_meta_seourl" value="{{ old('prod_meta_seourl') }}" placeholder="Đường dẫn SEO" autocomplete="off" spellcheck="false">
                                                    <input type="hidden" name="prod_meta_seourl" value="{{ old('prod_meta_seourl') }}">
                                                </div>
                                                <div class=" form_label" style="margin: 10px 0 0 220px;width: 100%;">
                                            ...
                                            <div class="form_group cateprod_meta_url d_flex align_items_center flex-wrap">
                                                <label for="prod_img"  class="form_label">Ảnh sản phẩm</label>
                                                <div class="form_input">
                                                    <input  type="file"  name="prod_img" class="form-control"
                                                    value="{{ old('prod_img') }}" id="prod_img">
                                                </div>
                                                <div class=" form_label" style="margin: 10px 0 0 200px">
                                                    @error('prod_img')
                                                    <p class="text-danger">{{ $message }}</p>
                                            ...
                                            <div class="form_group d_flex align_items_center flex-wrap">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" value="{{ old('prod_price_current') }}" type="number" name="prod_price_current" id="prod_price_current" placeholder="Giá bán" autocomplete="off" spellcheck="false">
                                                </div>
                                                <div class=" form_label" style="margin: 10px 0 0 200px">
                                                    @error('prod_price_current')
                                                    <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" value="{{ old('prod_price_old') }}" type="number" name="prod_price_old" id="prod_price_old" placeholder="Giá bán" autocomplete="off" spellcheck="false">
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form_list_wrap">
                                                        <select name="prod_cate_id" id="input" class="form-control">
                                                            ...
                                                            @foreach ( $categories as $cate )
                                                                <option value="{{ $cate->id }}">{{ $cate->cateprod_name }}</option>
                                                            @endforeach
                                                        </select>
