            ...
            <div class="page_header">
                <div class="container_fluid d_flex justify_content_between align_items_center">
                    ...
                    <div class="d_flex align_items_center">
                        <a class="btn_item btn_primary" href="{{ route('manager.product.add') }}">
                            <i class="fa fa-plus" aria-hidden="true"></i>
                            <span>Thêm mới</span>
                        </a>
                        <a class="btn_item btn_default" href="javascript:;">
                ...
                <div class="action_wrap d_flex align_items_center">
                    ...
                    <div class="page_action_item search grid_column_4">
                        <div class="value d_flex align_items_center w_100">
                            <form class="search_module w_100" method="" id="formSearch_Prod" data-url="">
                                ...
                                <tbody>
                                    ...
                                    @foreach ( $result as $value )
                                        <tr>
                                            <td>{{ $stt ++ }}</td>
                                            <td class="image">
                                                <img src="{{ url($value->prod_img) }}" alt="{{$value['thumbnail'] }}">
                                            </td>
                                            <td>{{ $value['prod_name'] }}</td>
                                            <td>{{ $value->cates['cateprod_name'] }}</td>
                                            <td>{{ $value['prod_price_current'] }}</td>
                                            <td>{{ $value['prod_price_old'] }}</td>
                                            <td>{{ $value['created_at'] }}</td>
                                            <td>
                                                <div class="toggle_status  position_relative {{ $value['prod_is_status'] }}">
                                            ...
                                            <td class="update">
                                                <a href="{{ route('manager.product.update',$value['id']) }}">
                                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                </a>
                                            </td>
                                            <td class="delete">
                                                <a href="{{ route('manager.product.delete',$value['id']) }}">
