...
<body>
    <div id="dashboardApp" class="showAside position_relative">
        <main class="main_content">
            <form action="{{ route('manager.update_store',$managerId->id) }}"  enctype="multipart/form-data" method="POST">
                @csrf
                                    ...
                                    <div class="form_group status_wrap d_flex align_items_center">
                                            ...
                                            <div class="switch_status">
                                                <label for="status_value" class="status_toggle on">
                                                        <input type="checkbox" {{ $managerId['user_is_active'] == "on" ? "checked" :null }} name="user_is_active" id="status_value" class="d_none">
                                        ...
                                        <div class="content_group">
                                            <div class="form_group d_flex align_items_center flex-wrap">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" value="{{ $managerId['username'] }}" type="text" name="fullname" id="fullname" placeholder="Nhập họ tên"  spellcheck="false">
                                                </div>
                                            ...
                                            <div class="form_group d_flex align_items_center flex-wrap">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" value="{{ $managerId['username'] }}" type="text" name="username" id="username" placeholder="Nhập username"  spellcheck="false">
                                                </div>
                                            ...
                                            <div class="form_group d_flex align_items_center flex-wrap">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" value="{{ $managerId['password'] }}" type="text" name="password" id="password" placeholder="Nhập mật khẩu"  spellcheck="false">
                                                </div>
                                            ...
                                            <div class="form_group d_flex align_items_center flex-wrap">
                                              ...
                                              <div class="form_input">
                                                  <input class="form_control" value="{{ $managerId['email'] }}" type="text" name="email" id="email" placeholder="Nhập email"  spellcheck="false">
                                              </div>
                                            ...
                                            <div class="form_group d_flex align_items_center">
                                              ...
                                              <div class="form_input">
                                                  <select class="form_control" name="role" id="role">
                                                          ...
                                                          <option {{ $managerId['role']== 1 ? "selected"  : null }} value="1">Manager</option>
                                                          <option {{ $managerId['role']== 2 ? "selected"  : null }}  value="2">User</option>
